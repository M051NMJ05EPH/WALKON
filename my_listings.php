...
try {
    ...
    $seller_id = $seller ? $seller['id'] : -1; // If no seller record, use -1 to show no products
...
<div class="container">
    <div class="header">
        ...
        <div>
            <a href="dashboard.php" style="color:#555; text-decoration:none; margin-right:20px;">Back to Dashboard</a>
            <a href="add_listing.php" class="btn-add"><i class="fas fa-plus"></i> Add New</a>
        </div>
    </div>
