...
// Fetch Categories
try {
    $categories = $pdo->query("SELECT *, (SELECT COUNT(*) FROM product_base pb WHERE pb.category_id = c.id) as product_count FROM categories c ORDER BY name ASC")->fetchAll(PDO::FETCH_ASSOC);
...
<head>
    ...
    <title>Category Setup | WALKON Admin</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav>
            ...
            <a href="categories.php" class="nav-link active"><i class="fas fa-layer-group"></i> Category Setup</a>
        ...
        <div class="page-header">
            <div style="display: flex; align-items: center;">
                ...
                <div class="page-title">
                    <h1>Platform Taxonomy.</h1>
                    <p style="color:var(--text-muted);">Define categories and organizational structures.</p>
                </div>
            </div>
            <a href="#" class="btn-add"><i class="fas fa-plus"></i> New Category</a>
        </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-weight:700; color:var(--primary-orange);"><?= $cat['product_count'] ?> Products</td>
                        <td><span style="color:#22c55e;"><i class="fas fa-check-circle"></i> Published</span></td>
                        <td><a href="#" style="color:var(--text-muted); text-decoration:none;"><i class="fas fa-edit"></i> Edit</a></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
