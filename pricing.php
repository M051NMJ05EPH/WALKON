...
<nav class="navbar">
  <div class="nav-container">
    ...
    <div class="nav-links">
      ...
      <a href="start_selling.php" class="btn btn-primary">Get Started</a>
    </div>
  </div>
</nav>
...
<div class="pricing-grid">
    ...
    <div class="pricing-card">
        ...
        <a href="start_selling.php?plan=free" class="btn btn-outline" style="width:100%; text-align:center;">Get Started</a>
    </div>
    ...
    <div class="pricing-card">
        ...
        <a href="start_selling.php?plan=starter" class="btn btn-outline" style="width:100%; text-align:center;">Select Plan</a>
    </div>
    ...
    <div class="pricing-card popular">
        ...
        <a href="start_selling.php?plan=pro" class="btn btn-primary" style="width:100%; text-align:center;">Select Plan</a>
    </div>
    ...
    <div class="pricing-card">
        ...
        <a href="start_selling.php?plan=enterprise" class="btn btn-outline" style="width:100%; text-align:center;">Contact Sales</a>
    </div>
</div>
