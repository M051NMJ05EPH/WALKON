...
<body>
    <div class="success-card">
        ...
        <h1>Added to Cart!</h1>
        <p>Item has been successfully added to your shopping cart. You can continue shopping or proceed to checkout.</p>
        <div style="display: flex; gap: 15px; justify-content: center;">
            <a href="shop.php" class="btn" style="background: transparent; border: 1px solid var(--border);">Continue Shopping</a>
            <a href="checkout.php" class="btn">View Cart & Checkout</a>
        </div>
    </div>
